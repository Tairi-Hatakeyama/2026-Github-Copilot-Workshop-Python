...
- [x] Sprint 0: 基盤整備
- [x] Sprint 1: ドメイン層のコア実装
- [x] Sprint 2: API層の実装
- [x] Sprint 3: フロントエンド基本実装
- [x] Sprint 4: 通知と統計機能
- [~] Sprint 5: UI磨きとテスト充実（部分完了）

### Sprint 5 の完了済み

- [x] フロントエンドロジックテストの追加（Vitest）
- [x] アクセシビリティの基本対応（ARIA、フォーカス可視化、キーボード操作）
- [x] レスポンシブの追加改善（480px以下の最適化）

### Sprint 5 の未完了

- [ ] E2Eシナリオテスト（手動またはPlaywright等で自動化）
- [ ] パフォーマンス最適化の定量確認（計測値ベース）
- [ ] モバイル/タブレット/デスクトップの実機確認
